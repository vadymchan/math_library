...
class InstructionSet<float> {
  ...
  template <Options Option>
  static inline __m256 loadB(const float* b,
                             const size_t innerIndex,
                             const size_t currentColB,
                             const size_t colsB,
                             const size_t colsA_rowsB) {
  ...
  template <Options Option>
  static void mul_avx2(float*       result,
                       const float* a,
                       const float* b,
                       size_t       rowsA,
                       size_t       colsB,
  ...
  template <Options Option>
  static void mul_avx(float*       result,
                      const float* a,
                      const float* b,
                      size_t       rowsA,
                      size_t       colsB,
  ...
  template <Options Option>
  static void mul_sse4_2(float*       result,
                         const float* a,
                         const float* b,
                         const size_t rowsA,
                         const size_t colsB,
  ...
  template <Options Option>
  static void mul_sse4_1(float*       result,
                         const float* a,
                         const float* b,
                         const size_t rowsA,
                         const size_t colsB,
  ...
  template <Options Option>
  static void mul_ssse3(float*       result,
                        const float* a,
                        const float* b,
                        const size_t rowsA,
                        const size_t colsB,
  ...
  template <Options Option>
  static void mul_sse3(float*       result,
                       const float* a,
                       const float* b,
                       const size_t rowsA,
                       const size_t colsB,
  ...
  template <Options Option>
  static void mul_fallback(float*       result,
                           const float* a,
                           const float* b,
                           const size_t rowsA,
                           const size_t colsB,
