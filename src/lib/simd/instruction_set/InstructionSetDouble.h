...
namespace math
{
	...
	private:
        ...
        template<Options Option>
        static void mul_avx2(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }

        template<Options Option>
        static void mul_avx(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }

        template<Options Option>
        static void mul_sse4_2(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }

        template<Options Option>
        static void mul_sse4_1(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }

        template<Options Option>
        static void mul_ssse3(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }

        template<Options Option>
        static void mul_sse3(double* result, const double* a, const double* b, size_t size)
        {
            mul_fallback<Option>(result, a, b, size);
        }
